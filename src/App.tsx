...
const serverResponse = {
  image:
    "https://github.com/JohnnyStorm19/RA_Composition_task-1/blob/main/src/assets/a-painting-of-a-mountain-lake-with-a-mountain-in-the-background.jpg?raw=true",
